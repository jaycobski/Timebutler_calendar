...
module.exports = {
  ...
  pages: {
    ...
    '/plan': ['vacation-plan-form', 'state-selector', 'states', 'holidays', 'bridgeWeekends', 'form', 'email', 'gdpr'],
    ...
    try {
      return import(`./src/i18n/${lang}.json`).then((m) => {
        ...
        const nsMapping = {
          ...
          'vacation-plan-form': ['vacationPlanForm', 'stateSelector', 'bridgeWeekendCard'],
